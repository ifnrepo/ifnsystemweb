...
$("#buttoncari").click(function(){
	...
	$.ajax({
		// dataType: "json",
		type: "POST",
		url: base_url + "billmaterial_cost/carisku",
		data: {
			kode: inputcari,
		},
		success: function (data) {
...
$("#kosongkankatcari").click(function(){
	$.ajax({
		// dataType: "json",
		type: "POST",
		url: base_url + "billmaterial_cost/kosongkancari",
		data: {
			kode: '',
		},
		success: function (data) {
...
$("#simpandetailbarang").click(function(){
	...
	$.ajax({
		dataType: "json",
		type: "POST",
		url: base_url + "billmaterial_cost/simpandetail",
		data: {
...
$("#updatedetailbarang").click(function(){
	...
	$.ajax({
		dataType: "json",
		type: "POST",
		url: base_url + "billmaterial_cost/updatedetail",
		data: {
			idhead: $("#id_header").val(),
			iddet: $("#id_detail").val(),
			id: $("#id_barang").val(),
...
$("#simpanmaterial").click(function(){
	...
	$.ajax({
		dataType: "json",
		type: "POST",
		url: base_url + "billmaterial_cost/simpandata",
		data: {
			po: $("#po").val(),
			item: $("#item").val(),
			dis: $("#dis").val(),
		...
		success: function (data) {
			if(data==0){
				...
				window.location.href = base_url+'billmaterial_cost/edit/'+data;
			}
		},
		error: function (xhr, ajaxOptions, thrownError) {
			console.log(xhr.status);
