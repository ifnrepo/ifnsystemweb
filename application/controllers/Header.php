...
class Header extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['footer'] = $this->headermodel->getdata();
    ...
    public function simpandata()
    {
        ...
        $hasil = $this->headermodel->simpan($data);
        $this->helpermodel->isilog($this->db->last_query());
        echo $hasil;
    }
    public function edit($id)
    {
        $data['data'] = $this->headermodel->getdatabyid($id);
        $this->load->view('header/edit', $data);
    }
    public function update()
    {
        ...
        $hasil = $this->headermodel->updatedata($data);
        $this->helpermodel->isilog($this->db->last_query());
        echo $hasil;
    }
    public function hapus($id)
    {
        $hasil = $this->headermodel->hapus($id);
        if ($hasil) {
            $this->helpermodel->isilog($this->db->last_query());
            $url = base_url('header');
            redirect($url);
