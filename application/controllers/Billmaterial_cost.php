...
class Billmaterial_cost extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('billmaterial_cost_model');
    ...
    public function index()
    {
        ...
        $data['material'] = $this->billmaterial_cost_model->getdata();
        $footer['data'] = $this->helpermodel->getdatafooter()->row_array();
        $footer['fungsi'] = 'billmaterial_cost';
        $this->load->view('layouts/header', $header);
        $this->load->view('billmaterial_cost/index', $data);
    ...
    {
        $data['data'] = $this->billmaterial_cost_model->getdatabyid($id);
        $data['detail'] = $this->billmaterial_cost_model->getdatadetailbyid($id);
        $this->load->view('billmaterial_cost/viewmaterial', $data);
    }
    public function tambahdata()
    {
        ...
        $footer['fungsi'] = 'billmaterial_cost';
        $this->load->view('layouts/header', $header);
        $this->load->view('billmaterial_cost/add');
        $this->load->view('layouts/footer', $footer);
    }
    public function edit($id)
    {
        $header['header'] = 'master';
        $data['material'] = $this->billmaterial_cost_model->getdatabyid($id);
        $data['detail'] = $this->billmaterial_cost_model->getdatadetailbyid($id);
        $footer['data'] = $this->helpermodel->getdatafooter()->row_array();
        $footer['fungsi'] = 'billmaterial_cost';
        $this->load->view('layouts/header', $header);
        $this->load->view('billmaterial_cost/edit', $data);
        $this->load->view('layouts/footer', $footer);
    }
    public function hapusdetail($id, $head)
    {
        $hasil = $this->billmaterial_cost_model->hapusdetail($id, $head);
        if ($hasil) {
            $url = base_url() . 'billmaterial_cost/edit/' . $head;
            redirect($url);
        }
    }
    ...
    public function simpandetail()
    {
        ...
        $hasil = $this->billmaterial_cost_model->simpandetail($data);
        if ($hasil) {
    ...
    public function updatedetail()
    {
        ...
        $hasil = $this->billmaterial_cost_model->updatedetail($data);
        if ($hasil) {
            $this->helpermodel->isilog($this->db->last_query());
        }
        echo $hasil;
