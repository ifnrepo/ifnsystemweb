    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-1 row">
                ...
                <div class="col">
                    <input type="text" class="form-control font-kecil" name="id" id="id" placeholder="Kode" value="<?= $data['id']; ?>">
                </div>
            </div>
            <div class="mb-1 row">
                <label class="col-3 col-form-label required">Produk (Englis)</label>
                <div class="col">
                    <input type="text" class="form-control font-kecil" name="engklp" id="engklp" placeholder="Kelompok Produk (Englis)" value="<?= $data['engklp']; ?>">
                </div>
            </div>
            <div class="mb-1 row">
                <label class="col-3 col-form-label required">Produk (Indonesia)</label>
                <div class="col">
                    <input type="text" class="form-control font-kecil" name="indklp" id="indklp" placeholder="Kelompok Produk (Indonesia)" value="<?= $data['indklp']; ?>">
                </div>
            </div>
            <div class="mb-1 row">
                <label class="col-3 col-form-label required">No HS</label>
                <div class="col">
                    <input type="text" class="form-control font-kecil" name="hs" id="hs" placeholder="No HS" value="<?= $data['hs']; ?>">
                </div>
            </div>
            <div class="mb-1 row">
            ...
            <div class="mb-1 row">
                ...
                <div class="col">
                    <input type="text" class="form-control font-kecil" name="kelco" id="kelco" placeholder="Kelompok Certificate" value="<?= $data['kelco']; ?>">
                </div>
            </div>
        </div>
    </div>
