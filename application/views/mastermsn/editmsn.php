      ...
      <div class="card-body font-kecil">
        <div class="row">
          ...
          <div class="col-8">
               ...
               <div class="row">
                <div class="col-6">
                  <div class="mb-1 row">
                    ...
                    <div class="col">
                      <input type="text" class="form-control font-kecil" id="tglmasuk" name="tglmasuk" value="<?= tglmysql($data['tglmasuk']); ?>" aria-describedby="emailHelp" placeholder="Tgl Masuk">
                    </div>
                  </div>
                  <div class="mb-1 row">
                ...
                <div class="col-6">
                  <div class="mb-1 row">
                    ...
                    <div class="col">
                      <input type="text" class="form-control font-kecil" id="tgl_bc" name="tgl_bc" value="<?= tglmysql($data['tgl_bc']); ?>" aria-describedby="emailHelp" placeholder="Tgl BC">
                    </div>
                  </div>
                  <div class="mb-1 row">
            ...
            <div class="mb-1 row">
              <label class="col-3 col-form-label font-bold">Harga (<?= $data['mt_uang']; ?>)</label>
              <div class="col">
                <input type="text" class="form-control font-kecil text-right inputangka" id="kode_fix" name="kode_fix" value="<?= rupiah($data['harga'],2); ?>" aria-describedby="emailHelp" placeholder="kode Fix">
              </div>
            </div>
            <div class="mb-1 row">
            ...
            <div class="mb-1 row">
              ...
              <div class="col">
                <div class="row">
                  <div class="col-6">
                    <input type="text" class="form-control font-kecil text-right inputangka" id="landing" name="landing" value="<?= rupiah($data['landing'],2); ?>" aria-describedby="emailHelp" placeholder="kode Fix">
                  </div>
                  <div class="col-6">
