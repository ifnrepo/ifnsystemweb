            ...
            <div class="card-body">
                <div class="card card-active mb-2">
                    <div class="card-body p-1 text-right">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5">
                                            <select name="thperiode" id="thperiode" class="form-control form-select font-kecil">
                                                <?php for($x=2020; $x<=date('Y');$x++){ $selek = $x == $this->session->userdata('th') ? 'selected' : ''; ?>
                            ...
                            <div class="row mb-0">
                                ...
                                <div class="col font-kecil">
                                    <select name="lokasimesin" id="lokasimesin" class="form-control form-select font-kecil">
                                        ...
                                        <?php foreach ($lokasi->result_array() as $loka) { $selek = $loka['lokasi'] == $this->session->userdata('lokasimesin') ? 'selected' : ''; ?>
                        ...
                        <div class="col-9">
                            <a href="<?= base_url() . 'Invmesin/excel'; ?>" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i><span class="ml-1">Export To Excel</span></a>
                ...
                <table class="table datatable9 table-hover" id="cobasisip">
                    ...
                    <tbody class="table-tbody" style="font-size: 13px !important;">
                        <?php $no=1; $saw=0; $in=0; $out=0;$adj=0; foreach ($data as $msn) { ?>
                            <?php 
                                if($msn['ok_stok']==1){
