                    ...
                    <div class="col-8">
                        <form name="formkolom" id="formkolom" action="<?= $actionkolom; ?>" method="post">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control font-kecil" name="safety_stock" id="safety_stock" value="<?= $data['safety_stock']; ?>" readonly>
                                </div>
                            </div>
                            <div class=" mb-1 row">
                            ...
                            <div class=" mb-1 row">
                                ...
                                <div class="col">
                                    <select class="form-select font-kecil" id="imdo" name="imdo">
                                        <option value="0" <?php if($data['imdo']==0){ echo "selected"; } ?>>Lokal</option>
                                        <option value="1" <?php if($data['imdo']==1){ echo "selected"; } ?>>Impor</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-1 row">
