    ...
    <div class="container-xl">
        <div class="row g-0 d-flex align-items-between">
            ...
            <div class="col-md-6" style="text-align: right;">
                <a href="<?= base_url() . 'supplier/tambahdata'; ?>" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-simple" data-title="Add Data Supplier"><i class="fa fa-plus"></i><span class="ml-1">Tambah Data</span></a>
            </div>
        </div>
    </div>
</div>
                            ...
                            foreach ($supplier as $key) : $no++; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url() . 'supplier/editsupplier/' . $key['id']; ?>" class="btn btn-sm btn-primary btn-icon text-white" rel="<?= $key['id']; ?>" title="Edit data">
