<div class="container-xl">
    ...
    <div class="row">
        <div class="col-3 text-center font-kecil p-3">
            ...
            <div class="font-bold">Edit Kurs BI Rate</div>
        </div>
        <div class="col-9">
            <div class="mb-1 row">
                <input type="text" id="id_header" value="<?= $id ?>" class="hilang">
                ...
                <div class="col">
                    <select class="form-control form-select font-kecil font-bold mr-1" id="bulankurs" name="bulankurs">
                        <?php for ($x = 1; $x <= 12; $x++) : ?>
                        <option value="<?= $x; ?>" <?php if ($bulan == $x) echo "selected"; ?>><?= namabulan($x); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
            </div>
            <div class="mb-1 row">
                ...
                <div class="col">
                    <select class="form-control form-select font-kecil font-bold mr-1" id="tahunkurs" name="tahunkurs">
                        <?php for ($x=-1; $x <= 11 ; $x++) { ?> 
                            <option value="<?= date('Y')-$x; ?>" <?php if($tahun==date('Y')-$x) echo "selected"; ?>><?= date('Y')-$x; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="mb-1 row">
                ...
                <div class="col">
                    <input type="text" id="kurs_usd" class="form-control form-input font-kecil text-right inputangka" value="<?= rupiah($usd,2) ?>">
                </div>
            </div>
            <div class="mb-1 row">
                <label class="col-3 col-form-label">Kurs JPY</label>
                <div class="col">
                    <input type="text" id="kurs_jpy" class="form-control form-input font-kecil text-right inputangka" value="<?= rupiah($jpy,2) ?>">
                </div>
            </div>
            <div class="mb-1 row">
                <label class="col-3 col-form-label">Kurs EUR</label>
                <div class="col">
                    <input type="text" id="kurs_eur" class="form-control form-input font-kecil text-right inputangka" value="<?= rupiah($eur,2) ?>">
                </div>
            </div>
        </div>
    </div>
...
<div class="modal-footer font-kecil">
    ...
    <button type="button" class="btn btn-primary btn-sm" id="buatkurs">Update</button>
</div>
<script>
