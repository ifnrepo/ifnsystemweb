    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tabs-profile-5">
                    <div>
                      ...
                      <span style="float: right;"><a href="<?= base_url() . 'kurs/addkurskmk'; ?>" class="btn btn-sm btn-success py-0 px-1 btn-flat" title="Add Entitas" data-bs-toggle="modal" data-bs-target="#modal-large" data-message="Hapus IB" data-title="Isi Data Kurs KMK"><i class="fa fa-plus mr-1"></i> Tambah Data</a></span>
                    </div>
                    <hr class="mt-3 mb-0">
          ...
          <div class="col-7 bg-primary-lt">YY</div>
        </div>
      </div>
    </div>
  </div>
