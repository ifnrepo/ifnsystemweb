                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col">
                                        <input type="email" id="po" class="form-control input-sm font-kecil" aria-describedby="emailHelp" value="">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <label class="col-3 col-form-label font-kecil font-bold">Item</label>
                                    <div class="col">
                                        <input type="email" id="item" class="form-control input-sm font-kecil" aria-describedby="emailHelp" value="">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <label class="col-3 col-form-label font-kecil font-bold">Dis</label>
                                    <div class="col">
                                        <input type="email" id="dis" class="form-control input-sm font-kecil" aria-describedby="emailHelp" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-8">
