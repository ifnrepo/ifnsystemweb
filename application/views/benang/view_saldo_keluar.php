                    ...
                    <div id="table-default" class="table-responsive">
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody class="table-tbody" style="font-size: 13px !important;">
                                <?php $no = 0;
                                $total = 0;
                                foreach ($saldo_keluar as $key) : $no++;
                                    $total += $key['jumlah'];
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a class="btn btn-sm btn-danger btn-icon text-white" id="hapusnettype" data-bs-toggle="modal" data-bs-target="#modal-danger" data-message="Akan menghapus data ini" data-href="<?= base_url() . 'benang/hapus_saldo_keluar/' . $key['id'] . '/' . $key['tanggal'] . '/' . $key['jumlah'] . '/' . $tb_detail_id . '/' . $id_barang; ?>" title="Hapus data">
                                ...
                                <?php endforeach; ?>
                                <tr>
                                    <td colspan="3" style="text-align: center; color:red;">Total Saldo Keluar </td>
