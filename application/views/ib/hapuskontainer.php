...
<div class="modal-footer">
    ...
    <a class="btn btn-sm btn-danger" style="color: white; padding-left: 20px !important;padding-right: 20px !important;" id="hapuskontainer">Ya</a>
</div>
<script>
    $("#hapuskontainer").click(function(){
        $.ajax({
            dataType: "json",
            type: "POST",
            url: base_url + "ib/hapuskont",
            data: {
                id: $("#idd").val(),
                head: $("#idx").val(),
            },
