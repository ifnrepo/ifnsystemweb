                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col">
                                                    <div class="input-group mb-2">
                                                        <?php $arahcarikontrak = $datheader['jns_bc']==262 ? 'addkontrak261' : 'addkontrak'; ?>
                                                        ...
                                                        <a href="<?= base_url().'ib/'.$arahcarikontrak.'/'.$datheader['id'].'/'.$datheader['dept_tuju']; ?>" class="btn btn-info font-kecil btn-flat <?= $hilangtomboladdkontrak; ?>" data-bs-toggle="modal" data-bs-target="#modal-large" data-message="Hapus IB" data-title="Pilih Kontrak" >Pilih</a>
