...
<div class="modal-footer">
    ...
    <a class="btn btn-sm btn-danger" style="color: white; padding-left: 20px !important;padding-right: 20px !important;" id="hapusentitas">Ya</a>
</div>
<script>
    $("#hapusentitas").click(function(){
        $.ajax({
            dataType: "json",
            type: "POST",
            url: base_url + "ib/hapusenti",
            data: {
                id: $("#idd").val(),
                head: $("#idx").val(),
            },
