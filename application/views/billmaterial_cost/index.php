        ...
        <div class="row g-0 d-flex align-items-between">
            <div class="col-md-6">
                <h2 class="page-title p-2">
                    Master Data Bill Of Material Cost
                </h2>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="text-align: right;">
                                ...
                                <div class="input-group mb-0">
                                    ...
                                    <input type="text" class="form-control form-sm font-kecil" placeholder="Cari SKU / Nama Barang" value="<?= $textcari; ?>" id="textcari" style="text-transform: uppercase; height: 38px;">
                        ...
                        <tbody class="table-tbody" style="font-size: 13px !important;">
                            ...
                            foreach ($material->result_array() as $key) : $no++;
                                ...
                                $namaspek = empty(trim($key['po']))
                                    ...
                                    : spekpo($key['po'], $key['item'], $key['dis']);

                            ?>
                                <tr>
                                    <td><?= $no; ?></td>
                                    <td class="text-primary"><a href="<?= base_url() . 'billmaterial_cost/view/' . $key['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-large" data-title="View Data" rel="<?= $key['id']; ?>" title="Edit data"><?= $sku; ?></a></td>
                                    <td><?= $namaspek; ?></td>
                                    <td><?= $key['insno']; ?></td>
                                    <td><?= $key['nobontr']; ?></td>
                                    <td><?= $key['nobale']; ?></td>
