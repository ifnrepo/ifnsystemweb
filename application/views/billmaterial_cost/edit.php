        ...
        <div class="row g-0 d-flex align-items-between">
            <div class="col-md-6">
                <h2 class="page-title p-2">
                    Edit Data Bill Of Material Cost
                </h2>
            </div>
                                    ...
                                    foreach ($detail->result_array() as $deta) : $no++;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-sm btn-danger btn-icon text-white" id="hapusdetail" data-bs-toggle="modal" data-bs-target="#modal-danger" data-message="Akan menghapus data ini" data-href="<?= base_url() . 'billmaterial_cost/hapusdetail/' . $deta['id'] . '/' . $material['id']  ?>" title="Hapus data">
