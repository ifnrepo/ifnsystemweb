...
<div class="page-body">
  <div class="container-xl">
    <div class="card">
      <div class="card-body font-kecil">
        <form method="POST" action="<?= $action; ?>" id="formtambahpersonil" name="formtambahpersonil" enctype="multipart/form-data">
          <div class="row">
            <div class="col-sm-3">
              <div class="bg-blue-lt p-1">
                <?php
                $path = 'assets/image/dokper/';
                $foto = $path . 'image.jpg'; // Gambar default sebelum upload
              ...
              <div class="text-center">
                ...
                <input type="file" name="filefoto" id="filefoto" style="display:none;" accept="image/*" onchange="loadFile(event)">

                <button type="button" class="btn btn-sm btn-info btn-flat" id="file_browser" onclick="document.getElementById('filefoto').click();">
                  <i class="fa fa-search mr-1"></i> Get Foto
                </button>
              </div>
            </div>
            <div class="col-sm-9">
