...
<?php } ?>
<?php $updatejs = '1768377839'; ?>
<!-- Custom JS -->
<script src="<?= base_url(); ?>assets/js/myscript.js?<?= $updatejs; ?>"></script>
<!-- <script src="<?= base_url(); ?>assets/js/refresh.js"></script> -->
<?php if (isset($fungsi) && $fungsi == 'opname') { ?>
	<script src="<?= base_url(); ?>assets/js/opname/opname.js?<?= $updatejs; ?>"></script>
<?php } ?>
<?php if (isset($fungsi) && $fungsi == 'dataopname') { ?>
	<script src="<?= base_url(); ?>assets/js/opname/dataopname.js?<?= $updatejs; ?>"></script>
<?php } ?>
<?php if (isset($fungsi) && $fungsi == 'regbarang') { ?>
	<script src="<?= base_url(); ?>assets/js/opname/regbarang.js?<?= $updatejs; ?>"></script>
<?php } ?>
