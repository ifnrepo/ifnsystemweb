...
<head>
  ...
  <link href=<?= base_url() . "assets/css/own-style.css?1764748068" ?> rel="stylesheet" />
  <style>
    .ui-autocomplete {
        ...
        <div class="collapse navbar-collapse pb-5" id="sidebar-menu">
          <ul class="navbar-nav pt-lg-3">
            ...
            <?php if ($this->session->userdata('cek_sublok') == '1') : ?>
              <li class="nav-item <?php if (isset($header) && $header == 'sublok') {
                                                    echo 'active';
                                                  } ?>">
                <a class="nav-link" href="<?= base_url() . 'sublok/clear'; ?>">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
