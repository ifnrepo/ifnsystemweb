        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              <li class="nav-item">
                <a class="nav-link <?php if(!isset($header)){ echo 'active'; } ?>" href="./" >
              ...
              <li class="nav-item dropdown <?= cekmenuheader($this->session->userdata('master')); ?>">
                <a class="nav-link dropdown-toggle <?php if(isset($header) && $header=='master'){ echo 'active';} ?>" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <div class="dropdown-menu <?php if(isset($header) && $header=='master'){ echo 'show active';} ?>">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item <?= cekmenudetail($this->session->userdata('master'),1); ?>" href="<?= base_url().'satuan'; ?>">
                        Satuan
                      </a>
                      <a class="dropdown-item <?= cekmenudetail($this->session->userdata('master'),2); ?>" href="./">
                        Kategori Barang
                      </a>
              ...
              <li class="nav-item <?= cekmenuheader($this->session->userdata('manajemen')); ?>">
                <a class="nav-link <?php if(isset($header) && $header=='manajemen'){ echo 'active';} ?>" href="<?= base_url().'userapps'; ?>" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>
                  </span>
                  <span class="nav-link-title">
                    User Manajemen
                  </span>
