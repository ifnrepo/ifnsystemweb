                            ...
                            <div class="card card-active">
                                <div class="card-body p-2">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col mb-1">
                                            <select name="machnoonmesin" id="machnoonmesin" class="form-control form-select btn-flat font-kecil">
                                    ...
                                    <div id="form-hasilcari">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mb-1">
                                                ...
                                                <textarea name="spek" id="spek" class="form-control btn-flat font-kecil" readonly></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                            ...
                            <div id="cardisi" class="hilang">
                                <div class="card-body" style="min-height: 329px !important;">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bunko" id="bunko" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bunjmlbox" id="bunjmlbox" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bunbrtbox" id="bunbrtbox" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bunjmlmsn" id="bunjmlmsn" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bobjmlmsn" id="bobjmlmsn" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="jmbobspl" id="jmbobspl" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <select name="jnsbob" id="jnsbob" class="form-control form-select font-kecil">
                                                        ...
                                                        <?php foreach($bobin->result_array() as $bob): ?>
                                                            <option value="<?= $bob['kodebob'] ?>"><?= $bob['kodebob'] ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bobko" id="bobko" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="bobisi" id="bobisi" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="lot_dari" id="lot_dari" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <label class="col-7 col-form-label font-kecil line-11">Lot di Mesin (12)<br><span class="text-lime font-10">Sampai</span></label>
                                                <div class="col mb-1">
                                                    <input type="text" name="lot_sampai" id="lot_sampai" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col mb-1">
                                                    <input type="text" name="rpm" id="rpm" class="form-control btn-flat font-kecil text-right inputangka" value="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="#" class="btn btn-sm btn-success" id="simpandataonmachine">Simpan Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
