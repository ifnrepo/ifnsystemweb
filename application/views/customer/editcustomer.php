    ...
    <div class="container-xl">
        <div class="row g-0 d-flex align-items-between">
            ...
            <div class="col-md-6" style="text-align: right;">
                <a href="<?= base_url('customer'); ?>" class="btn btn-warning btn-sm text-black"><i class="fa fa-arrow-left"></i><span class="ml-1">Kembali</span></a>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-1 row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control font-kecil" name="kode_customer" id="kode_customer" value="<?= $data['kode_customer']; ?>">
                                </div>
                            </div>
                            <div class="mb-1 row">
                                <label class="col-3 col-form-label required">Nama Customer</label>
                                <div class="col">
                                    <input type="text" class="form-control font-kecil" name="nama_customer" id="nama_customer" value="<?= $data['nama_customer']; ?>">
                                </div>
                            </div>
                            <div class="mb-1 row">
