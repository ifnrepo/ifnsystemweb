<div class="container-xl">
    <div class="row mb-1">
        ...
        <div class="col-7 text-primary font-bold">
            ...
            <h4 class="mb-0 text-teal-green"><?= namaspekbarang($header['id_barang'],'kode') . " # " . $spekbarang; ?></h4>
            ...
            <table class="table datatable6 table-hover table-bordered mb-0" id="cobasisip">
                ...
                <tbody class="table-tbody" id="body-table" style="font-size: 13px !important;">
                    ...
                    foreach ($detail->result_array() as $det) {
                        ...
                        $init++;
                        if ($init == 1) {
                            $saldoawal = $det['saldopcs'] + $det['inpcs'] - $det['outpcs'];
                            $saldoawalkgs = $det['saldokgs'] + $det['inkgs'] - $det['outkgs'];
                        } else {
                            $saldoawal = $saldo;
                        ...
                        $saldo += $det['saldopcs'] + $det['inpcs'] - $det['outpcs'];
                        $saldokgs += $det['saldokgs'] + $det['inkgs'] - $det['outkgs'];
