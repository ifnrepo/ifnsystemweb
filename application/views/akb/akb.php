            ...
            <div class="card-body p-2 font-kecil">
              <div class="row">
                ...
                <div class="col-5">
                  ...
                  <?php $jmlrek = $jumlahrek->row_array(); $jumlahpcs=0; if(isset($jmlrek['jumlahitemnya'])) { $jumlahpcs = $jmlrek['jumlahitemnya']; } ?>
                  <span class="mb-1 font-kecil text-primary font-bold">Jumlah Detail : <?= rupiah($jumlahpcs,0).' Item' ?></span>
                </div>
                <div class="col-2">
                  <h4 class="mb-1">
                    <?php if($disab!=''){ ?>
