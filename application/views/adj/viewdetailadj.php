<div class="container-xl"> 
    ...
    <?php if($mode==1): 
        ...
        <a href="#" style="padding: 5px !important" data-bs-target="#modal-info" data-message="Anda yakin akan validasi bon <br><?= $header['nomor_dok']; ?>" data-href="<?= base_url() . 'task/validasiadj/' . $header['id'] ?>" data data-bs-toggle="modal" data-title="Validasi Bon" class="btn btn-sm btn-info">Approve Dokumen</a>
