        ...
        <div class="card-body">
            <table id="tabel" class="table nowrap order-column table-hover datatable7" style="width: 100% !important;">
                ...
                <tbody class="table-tbody" id="body-table" style="font-size: 13px !important;">
                  <?php foreach ($databbl->result_array() as $datpb) { ?>
                    <tr>
                      <td><?= tglmysql($datpb['tgl']); ?></td>
                      <td><a href="<?=  base_url() . 'bbl/viewdetail_bbl/' . $datpb['id'] ?>" data-bs-toggle="offcanvas" data-bs-target="#canvasdet" data-title="View detail"><?= $datpb['nomor_dok']; ?></a></td>
