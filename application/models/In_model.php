        ...
        if($cek==1){
            ...
            foreach($detail as $det){
                $kondisistok = [
                    ...
                    'dis' => $det['dis'],
                    'dln' => $det['dln'],
                    'trim(nobale)' => (($det['dept_id']=='FN' && $det['dept_tuju']=='GF') || ($det['dept_id']=='GW' && $det['dept_tuju']=='GF') || ($det['dept_id']=='GW' && $det['dept_tuju']=='FG') || ($det['dept_id']=='SP' && $det['dept_tuju']=='GW')) ? trim($det['nobale']) : '',
                ...
                if($adaisi->num_rows()==0){
                    ...
                    'dis' => $det['dis'],
                    'dln' => $det['dln'],
                    'nobale' => (($det['dept_id']=='FN' && $det['dept_tuju']=='GF') || ($det['dept_id']=='GW' && $det['dept_tuju']=='GF') || ($det['dept_id']=='GW' && $det['dept_tuju']=='FG') || ($det['dept_id']=='SP' && $det['dept_tuju']=='GW')) ? trim($det['nobale']) : '',
                    'nomor_bc' => in_array($det['dept_tuju'],daftardeptsubkon()) ? trim($dataheader['nomor_bcmasuk']) : '',
