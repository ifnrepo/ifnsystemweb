...
class Bcmasukmodel extends CI_Model
{
    public function getdata(){
        ...
        $this->db->select('tb_header.*,supplier.*,sum(tb_detail.pcs) as pcs,sum(tb_detail.kgs) as kgs,tb_header.id as idx,ref_kemas.kemasan');
    ...
    public function getdatabyid($id){
        $this->db->select('tb_header.*,supplier.*,sum(tb_detail.pcs) as pcs,sum(tb_detail.kgs) as kgs,tb_header.id as idx,ref_jns_angkutan.angkutan as xangkutan,ref_mt_uang.mt_uang as xmt_uang,ref_kemas.kemasan');
        $this->db->join('supplier','supplier.id = tb_header.id_pemasok','left');
        $this->db->join('tb_detail','tb_detail.id_header = tb_header.id','left');
